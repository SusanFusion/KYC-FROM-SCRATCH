...
export default async function PenaltiesPage() {
  const [{ period, agents, results }, user] = await Promise.all([loadPeriodDataset(), getCurrentUser()]);
  ...
  return (
    <>
      ...
      <PageShell>
        ...
        {period && !isLead && (
          <p className="mt-4 text-xs text-muted-foreground">Sign in as a Lead/Manager to record a penalty.</p>
        )}
