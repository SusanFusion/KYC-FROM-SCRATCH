          ...
          <CardContent className="flex flex-col gap-4 p-5 sm:flex-row sm:items-center sm:justify-between">
            ...
            {isLead ? (
              ...
              <a
                ...
                className="inline-flex flex-shrink-0 items-center gap-2 rounded-md border border-primary-200 bg-white px-4 py-2.5 text-sm font-semibold text-primary-700 shadow-sm transition-colors hover:bg-primary-50"
              >
                <Download className="h-4 w-4" />
                Sign in as a Lead to export
              </a>
            )}
          </CardContent>
        </Card>
