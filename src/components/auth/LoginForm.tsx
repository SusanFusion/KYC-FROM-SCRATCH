  ...
  return (
    <Card className="w-full max-w-sm shadow-card">
      <CardHeader className="items-center text-center">
        ...
        <CardDescription>Sign in with your Fusion Markets email.</CardDescription>
      </CardHeader>
      <CardContent>
        ...
        <p className="mt-4 text-center text-[11px] text-muted-foreground">
          Agents and Leads/Managers each use one shared team password — ask your lead if you don&apos;t have it.
        </p>
      </CardContent>
    </Card>
  );
